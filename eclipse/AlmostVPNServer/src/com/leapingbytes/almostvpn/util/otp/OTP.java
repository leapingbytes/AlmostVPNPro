package com.leapingbytes.almostvpn.util.otp;

/* Class for implementing OTP (aka s/key) one-time password calculation
 * using the accompanying md class for md4 and md5-based key calculation.
 *
...
public class OTP {
	...
	public OTP(int n, String s, String p, int hashalg) {
		this.seq = n;
		this.seed = s;
		this.passphrase = p;
		this.sha = hashalg;

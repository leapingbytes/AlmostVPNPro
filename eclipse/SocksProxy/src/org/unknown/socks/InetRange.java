...
public class InetRange implements Cloneable{
    ...
    public synchronized boolean remove(String s){
      ...
      while(allElements.hasMoreElements()){
        Object[] entry = (Object[]) allElements.nextElement();
        if(s.equals(entry[0])){
...
/////////////////
    ...
    private synchronized boolean contains(long ip){
       Enumeration allElements = all.elements();
       while(allElements.hasMoreElements()){
         Object[] obj = (Object[]) allElements.nextElement();
    ...
    private boolean checkHostEnding(String host){
       Enumeration endNamesElements = end_names.elements();
       while(endNamesElements.hasMoreElements()){
          if(host.endsWith((String) endNamesElements.nextElement())) return true;
       }
       return false;
    }

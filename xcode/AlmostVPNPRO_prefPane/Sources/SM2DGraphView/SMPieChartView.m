...
//                    && ![ self inLiveResize ] )
        {
            ...
            for ( sliceIndex = 0; sliceIndex < sliceCount; sliceIndex++ )
            {
                ...
                tempColor = [ [ myPrivateData->sliceAttributes objectAtIndex:sliceIndex ]
...
static NSDictionary *_sm_local_defaultSliceAttributes( unsigned int inSliceIndex )
{
    ...
    return [ NSDictionary dictionaryWithObject:tempColor forKey:NSBackgroundColorAttributeName ];
}

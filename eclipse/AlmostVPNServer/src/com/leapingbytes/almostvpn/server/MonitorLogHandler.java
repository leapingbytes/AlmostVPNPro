...
public class MonitorLogHandler extends Handler implements Profile.StateListener {
	...
	public MonitorLogHandler(OutputStream os) {
		...
		emmit( "PING:" + System.currentTimeMillis(), true );		
		//
	...
	*/
	...
	synchronized void emmit( String line, boolean forceFlush ) {
		if( _outputStream == null ) {
			return;
		}
		try {
...
class IdleEventSender extends TimerTask {
	...
	public void run() {
		_handler.emmit( "PING:" + System.currentTimeMillis(), true );
	}	
}

...
public class ScriptRunner {
	...
	private static boolean testScriptIntegrity( String scriptName ) {
		String scriptMD5 = getRegistredMD5Checksum( scriptName );
		if( scriptMD5 == null ) {
			return false;
		}
		String md5 = null;
	...
	public static String getRegistredMD5Checksum( String fileName ) {
		...
		NSDictionary scriptChecksum = (NSDictionary) _scripts_checksums.objectForKey( fileName );
		
		return scriptChecksum == null ? null : (String) scriptChecksum.objectForKey( "md5" );
	}	
}

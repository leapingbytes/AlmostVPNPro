...
+ (void) savePassword: (NSString*) password ofType: (SecProtocolType) type forAccount: (NSString*) account onServer: (NSString*) serverName forPath: (NSString*)path intoKeychain: (SecKeychainRef)keychain;
+ (NSString*) retrivePasswordOfType: (SecProtocolType) type forAccount: (NSString*) account onServer: (NSString*) serverName forPath: (NSString*)path fromKeychain: (SecKeychainRef)keychain;
...
+ (OSStatus) preauthorize: (NSArray*) tools;
+ (BOOL) isAuthorized;
+ (void) unauthorize;
